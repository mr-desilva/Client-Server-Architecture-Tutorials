 ...
 * 
 */
@WebServiceClient(name = "SimpleWebService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Tutorial3/SimpleWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Tutorial3/SimpleWebService?wsdl");
