...
public interface Tutorial5WebService {
    ...
    @Action(input = "http://server/Tutorial5WebService/getAverageRequest", output = "http://server/Tutorial5WebService/getAverageResponse", fault = {
        @FaultAction(className = Exception_Exception.class, value = "http://server/Tutorial5WebService/getAverage/Fault/Exception")
    })
    ...
    @Action(input = "http://server/Tutorial5WebService/getMinimumRequest", output = "http://server/Tutorial5WebService/getMinimumResponse", fault = {
        @FaultAction(className = Exception_Exception.class, value = "http://server/Tutorial5WebService/getMinimum/Fault/Exception")
    })
