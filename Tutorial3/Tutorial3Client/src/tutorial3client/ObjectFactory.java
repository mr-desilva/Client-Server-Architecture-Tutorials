 ...
 * generated in the tutorial3client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetIPResponse_QNAME = new QName("http://server/", "getIPResponse");
    ...
    private final static QName _GetIP_QNAME = new QName("http://server/", "getIP");
    private final static QName _HelloResponse_QNAME = new QName("http://server/", "helloResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tutorial3client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getIPResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getIP")
